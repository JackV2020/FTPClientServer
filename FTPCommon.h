...
#define FTP_CMD_LE_XMKD 0x444b4d58       // "XMKD"  as uint32_t (little endian)
#define FTP_CMD_BE_XMKD 0x584d4bdd       // "XMKD"  as uint32_t (little endian)
...
#define FTP_CMD_LE_XRMD 0x444d5258       // "XRMD"  as uint32_t (little endian)
#define FTP_CMD_BE_XRMD 0x58524d44       // "XRMD" as uint32_t (big endian)
